...
def get_params():
    ...
    if len(sys.argv) == 3:
        ...
        raise Exception("Invalid usage.\n\nRun: python idaweb_scraper.py <weather_param> <year>\n\n"
...
main_directory_location= "/home/ema/Dropbox/ada/scraper/"
...
if __name__ == "__main__":
    ...
    first_quarter = ['01.01.'+year, '30.04.'+year]
    second_quarter = ['01.05.'+year, '31.08.'+year]
    third_quarter = ['01.09.'+year, '31.12.'+year]
    ...
    try:
        ...
        for idx, quarter in enumerate(quarters):
            log.write("Time span: " + str(quarter) + "\n")
            ...
            driver.find_element_by_xpath("//input[@name='since']").send_keys(quarter[0])
            driver.find_element_by_xpath("//input[@name='till']").send_keys(quarter[1])
            ...
            if check_exists_by_xpath("//div[@id='no_results']"):
                ...
                with open(param_filename, 'a') as f:
                    f.write(quarter[0] + " " + quarter[1] + " " + str(idx) + "\n")
